## NAOKI VPS MANGER SELECTOR
## run
## Execution

```
bash <(curl -fsSL https://raw.githubusercontent.com/Thet2004/Selector/main/Sel.sh)
```
---
...
```
bash <(curl -fsSL https://raw.githubusercontent.com/Thet2004/Selector/main/install.sh)
```
---
